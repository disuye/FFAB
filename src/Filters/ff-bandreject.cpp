...
FFBandreject::FFBandreject() {
    position = Position::MIDDLE;
    updateFFmpegFlags();
}

QWidget* FFBandreject::getParametersWidget() {
    ...
    auto frequencyGroup = new QGroupBox("Notch Frequency (Hz)");
    ...
    // Width
    auto widthGroup = new QGroupBox("Notch Width");
...
void FFBandreject::updateFFmpegFlags() {
    ...
    ffmpegFlags = QString("bandreject=frequency=%1:width_type=%2:width=%3:mix=%4:normalize=%5:transform=%6:precision=%7")
...
QString FFBandreject::buildFFmpegFlags() const {
    return ffmpegFlags;
}

void FFBandreject::toJSON(QJsonObject& json) const {
    json["type"] = "ff-bandreject";
...
void FFBandreject::fromJSON(const QJsonObject& json) {
