...
QWidget* FFBass::getParametersWidget() {
    ...
    // ========== TAB 1: BASS ==========
    auto bassTab = new QWidget();
    auto bassLayout = new QVBoxLayout(bassTab);
    ...
    bassLayout->addWidget(frequencyGroup);
    ...
    bassLayout->addWidget(gainGroup);
    ...
    bassLayout->addWidget(widthTypeGroup);
    ...
    bassLayout->addWidget(widthGroup);
    ...
    bassLayout->addWidget(polesGroup);

    bassLayout->addStretch();
    tabWidget->addTab(bassTab, "Bass");
...
void FFBass::updateFFmpegFlags() {
    ...
    ffmpegFlags = QString("bass=frequency=%1:width_type=%2:width=%3:gain=%4:poles=%5:mix=%6:normalize=%7:transform=%8:precision=%9")
...
QString FFBass::buildFFmpegFlags() const {
    return ffmpegFlags;
}

void FFBass::toJSON(QJsonObject& json) const {
    json["type"] = "ff-bass";
...
void FFBass::fromJSON(const QJsonObject& json) {
