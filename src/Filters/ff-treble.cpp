...
QWidget* FFTreble::getParametersWidget() {
    ...
    // ========== TAB 1: TREBLE ==========
    auto trebleTab = new QWidget();
    auto trebleLayout = new QVBoxLayout(trebleTab);
    ...
    trebleLayout->addWidget(frequencyGroup);
    ...
    trebleLayout->addWidget(gainGroup);
    ...
    trebleLayout->addWidget(widthTypeGroup);
    ...
    trebleLayout->addWidget(widthGroup);
    ...
    trebleLayout->addWidget(polesGroup);

    trebleLayout->addStretch();
    tabWidget->addTab(trebleTab, "Treble");
...
void FFTreble::updateFFmpegFlags() {
    ...
    ffmpegFlags = QString("treble=frequency=%1:width_type=%2:width=%3:gain=%4:poles=%5:mix=%6:normalize=%7:transform=%8:precision=%9")
...
QString FFTreble::buildFFmpegFlags() const {
    return ffmpegFlags;
}

void FFTreble::toJSON(QJsonObject& json) const {
    json["type"] = "ff-treble";
...
void FFTreble::fromJSON(const QJsonObject& json) {
