...
QWidget* FFLowpass::getParametersWidget() {
...
void FFLowpass::updateFFmpegFlags() {
    ...
    ffmpegFlags = QString("lowpass=frequency=%1:width_type=%2:width=%3:poles=%4:mix=%5:normalize=%6:transform=%7:precision=%8")
...
QString FFLowpass::buildFFmpegFlags() const {
    return ffmpegFlags;
}

void FFLowpass::toJSON(QJsonObject& json) const {
    json["type"] = "ff-lowpass";
...
void FFLowpass::fromJSON(const QJsonObject& json) {
    m_frequency = json["frequency"].toDouble(500.0);
