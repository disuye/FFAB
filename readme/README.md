...
![Native dark mode](./ffab-mode-dark.png)
*Native dark mode...*
...
![Psychopath mode](./ffab-mode-light.png)
*...and psychopath mode.*
...
![Command output](./ffab-viewcommand.png)
...
![FFAB user interface](./ffab-filterchain.png)
...
![Filter insert controls](./ffab-filter-insert.png)
...
![Real-time preview of FFmpeg log data](./ffab-viewlog.png)
*Real-time preview of FFmpeg log data*

![Choose the amount of logging you need...](./ffab-loglevel.png)
*Choose the amount of logging you need...*

![... and where to save the log data](./ffab-logfile.png)
...
![Generate Preview widget](./ffab-preview-widget.png)
...
![Audio Preview pop-out](./ffab-preview-window.png)
...
![Batch Algorithm #1](./ffab-batch01.png)
...
![Batch Algorithm #2](./ffab-batch02.png)
...
![Batch Algorithm #3](./ffab-batch03.png)
...
![Batch Algorithm #4](./ffab-batch04.png)
...
![Batch Algorithm #5](./ffab-batch05.png)
...
![Batch Algorithm #6](./ffab-batch06.png)
...
![Batch Algorithm #7](./ffab-batch07.png)
*Batch Algorithm #7: Cartesian / many to many (too many!)...*

![Batch confirmation](./ffab-batch07confirm.png)
...
![Audio Input filter](./ffab-audioinput.png)
...
![Aux Output uncompressed](./ffab-auxoutput-uncompressed.png)
*Output as many concurrent file formats as FFmpeg & your storage disk can handle*

![Aux Output advanced](./ffab-auxoutput-advanced.png)
...
![Smart Aux Return](./ffab-smartauxreturn.png)
...
![Custom FFmpeg](./ffab-customffmpeg.png)
...
![FFmpeg Installer](./ffab-ffmpeginstall.png)
